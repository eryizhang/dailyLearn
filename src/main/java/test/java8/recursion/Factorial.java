...
public class Factorial<T, R> {
     ...
     * @return 第n个斐波那契数
     */
    private  long fibonacciCallMemo(Function<Integer,Long> fib,Integer n){
        if (n == 0 || n == 1) {return 1;}
     ...
     */
    public  <T, R> R callMemo(final BiFunction<Function<T, R>, T, R> function, final T input) {
