...
public class ReentreLockTest {
    ...
    static class SemaTest extends LockTest {
    ...
    static class LockTestSon extends LockTest {

        public LockTestSon(String id, CyclicBarrier barrier, long count,
                        int threadNum, ExecutorService executor) {
            super(id, barrier, count, threadNum, executor);
        }
    ...
    static class SyncTest extends LockTest {
    ...
    static class AtomicTest extends LockTest {
    ...
    public static void test(String id, long count, int threadNum,
        ...
        final CyclicBarrier barrier = new CyclicBarrier(threadNum + 1,
                new Thread() {
                    ...
                    @Override
                    public void run() {
                        System.out.println("***********barrier条件达成************");
                    }
                });
        ...
        new LockTestSon("Lock ", barrier, COUNT, threadNum, executor).startTest();
